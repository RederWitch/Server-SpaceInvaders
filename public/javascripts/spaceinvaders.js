class Game{
    ...
    deleteAlien(index){
        this.score +=this.aliens[index].points;
        var tem = this.aliens;
        this.aliens = [];
        if(tem.length - 1 ===0){
            this.win();
    ...
    win(){
        ...
        this.context.fillStyle = '#ffffff';
        this.context.textBaseline="center";
        this.context.fillText("YOU PASSED A LV", this.width / 2, this.height/2 - 40);
        document.getElementById("btn_newGame").style.visibility= "visible";

        document.getElementById("btn_save").style.visibility= "visible";
        document.getElementById("btn_nextLevel").style.visibility= "visible";
    }
